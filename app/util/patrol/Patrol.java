...
public class Patrol {
	 ...
	 * @param localPath
	 */
	public Patrol(Long nodeTypeId, Long jobId, String localPath) {
	 ...
	 * @throws SQLException
	 */
	public void autoPatrol() throws IOException, SQLException {
			...
			for (int i = 0; i < scripts; i++) {
				...
				if (type.equalsIgnoreCase("command")) {
					...
					output = PSClient.execCommands(
							"powershell -f " + localPath + "/" + nodeTypeId.toString() + nodeId.toString() + ".ps1");
