...
@Entity
@Table(name="T_RES_VM_Temp",uniqueConstraints={@UniqueConstraint(columnNames={"IP","WORK_ORDER_ID","VS_ID"})})
@AccessType("field")
public class TResVMTemp extends Model {
	//虚机名称	
	@Required
	public String NAME;
	//系统信息	
